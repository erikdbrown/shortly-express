...
exports.addNewUser = function(req, res, next) {
  var user = new User({username: req.body.username, passwordHash: req.body.password });
...
exports.logoutUser = function(req, res, next) {
  console.log('logoutUser req.session: ', req.session);
  var sess = req.session;
  sess.user = undefined;
  console.log('logoutUser req.session after undefined: ', req.session);
  res.redirect('/');
  // res.render('login');
};
